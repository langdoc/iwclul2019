...
Since the Kildin Saami model has never seen the characters not used in Kildin Saami, it can be assumed that it performs poorly with data from other languages. This is indeed the case, as plot below summarises. With the mixed test set Kildin Saami model has an arror rate of 9%.
